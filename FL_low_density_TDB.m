...
% for    feature_length = (0.7:0.07:6.3)
    ...
    for index = 1:size(Individual_No_array,1)
        ...
        save([Disk_Letter_Name,':\Liam Passport\Study 1 Data\processing_code\training_data_bases\TDB_',Individual_No,'_Feature_length_',num2str(round(100*feature_length)),'.mat'],'TDB_1','TDB_2','TDB_3','TDB_4','TDB_5','dim1','dim2')
