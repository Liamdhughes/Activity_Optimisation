...
for multiplication_factor = 1:6
    ...
    for index = 1:size(Individual_No_array,1)
     ...
     for fig_No = 1:5
        ...
        save([Disk_Letter_Name,':\Liam Passport\Study 1 Data\processing_code\training_data_bases\high_density\high_density_TDB_',Individual_No,'_multiplication_factor_',num2str(multiplication_factor),'.mat'],'TDB_1','TDB_2','TDB_3','TDB_4','TDB_5','boundary')
