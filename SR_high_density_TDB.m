...
for S_R = 15:5:100
    ...
    for index = 1:size(Individual_No_array,1)
        ...
        load([Disk_Letter_Name,':\Liam Passport\Study 1 Data\P0',Individual_No,'\corrected_data_at_',num2str(S_R),'_Hz.mat'])
     ...
     for fig_No = 1:5
        ...
        save([Disk_Letter_Name,':\Liam Passport\Study 1 Data\processing_code\training_data_bases\high_density\high_density_TDB_',Individual_No,'_sampling_rate_',num2str(S_R),'.mat'],'TDB_1','TDB_2','TDB_3','TDB_4','TDB_5','boundary')
