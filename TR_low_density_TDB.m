...
%         pause(100)
        ...
        save(['D:\Liam Passport\Study 1 Data\processing_code\training_data_bases\TDB_',Individual_No,'_TR_',num2str(round(1000*temporal_resolution)),'.mat'],'TDB_1','TDB_2','TDB_3','TDB_4','TDB_5','dim1','dim2')
